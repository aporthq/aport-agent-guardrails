...
check_pack "run_terminal_cmd" "system.command.execute.v1"
...
check_pack "image_gen.imagegen" "media.image.generate.v1"
check_pack "image_genimagegen" "media.image.generate.v1"
check_pack "image.generate" "media.image.generate.v1"
check_pack "imagegeneration" "media.image.generate.v1"
check_pack "write" "data.file.write.v1"
check_pack "edit_file" "data.file.write.v1"
check_pack "delete_file" "data.file.write.v1"
check_pack "mcp.tool" "mcp.tool.execute.v1"
check_pack "read_mcp_resource" "mcp.tool.execute.v1"
check_pack "list_mcp_resources" "mcp.tool.execute.v1"
...
check_pack "list_dir" "data.file.read.v1"
check_pack "grep_search" "data.file.read.v1"
check_pack "file_search" "data.file.read.v1"
check_pack "browser" "web.browser.v1"
check_pack "release.publish" "code.release.publish.v1"
check_pack "git.release" "code.release.publish.v1"
